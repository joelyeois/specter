...
def main() -> None:
    ...
    # shape and rely on Lightning's automatic _sync_module_states() to receive
    # rank 0's real bank before predicting.
    icecube_size = (
        args.icecube_size
        if args.icecube_size is not None
        else min(args.num_pixels, int(256 / pixel_size.item()))
    )
    icemaker = None
