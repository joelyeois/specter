...
def load_config(
    ...
    | type[TomogramConfig]
    | type[IceCacheConfig] = ParticleStackConfig,
) -> (
    ParticleStackConfig
    | MicrographConfig
    | TiltSeriesConfig
    ...
    config_cls : type[ParticleStackConfig] | type[MicrographConfig] | type[TiltSeriesConfig] | type[TomogramConfig] | type[IceCacheConfig]
        Dataclass to populate from the TOML fields. Defaults to
        `ParticleStackConfig` for backward compatibility.

    Returns
    -------
    ParticleStackConfig | MicrographConfig | TiltSeriesConfig | TomogramConfig | IceCacheConfig
...
def validate_config(config: Any) -> None:
    ...
    _require_existing_file(config, "cs_path", "star_path", "shtyrov_params_path")
