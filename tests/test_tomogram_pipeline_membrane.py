...
wiring (specter.pipelines._tomogram._build_tomogram_generator) --
...
from specter.pipelines._tomogram import _build_tomogram_generator
...
def test_n_instances_greater_than_one_with_explicit_position_xyz_raises():
    ...
    with pytest.raises(ValueError, match="n_instances"):
        _build_tomogram_generator(config)
...
def test_render_workers_and_devices_reach_membrane_tomogram_generator():
    ...
    # _build_tomogram_generator's own pre-render comment).
